 ...
 * @link Doka Image Editor Docs: https://pqina.nl/doka/docs/v7/api/plugins/filter/#filterfunctions
...
type DokaNode =
    | [any, string]
    | [any, string, DokaNodeOptions]
    | [any, string, DokaNodeOptions, DokaNode[]];

interface EditorOptionsRequired {
    locale: any;
    imageReader: any[];
}

interface EditorOptionsOptional {
    locale?: any;
    imageReader?: any[];
}
...
interface DokaImageEditorDefaultOptions
    extends EditorOptionsOptional,
        EditorOptions,
        EditorImageOptions,
        AnnotatePluginOptions,
        CropPluginOptions,
...
export const getEditorDefaults: (
    options?: DokaImageEditorDefaultOptions
) => DokaImageEditorDefaultOptions;
...
export const openDefaultEditor: (options: DokaImageEditorDefaultOptions) => DokaImageEditorModal;

export const defineCustomElements: (options?: DokaImageEditorOptions) => Promise<DokaImageEditor>;

export const defineDefaultCustomElements: (
    options?: DokaImageEditorDefaultOptions
) => Promise<DokaImageEditor>;
...
// plugins
//
interface DokaUtilPlugin {
    util: [string, any];
}

export const plugin_annotate: DokaUtilPlugin;
export const plugin_crop: DokaUtilPlugin;
export const plugin_decorate: DokaUtilPlugin;
export const plugin_filter: DokaUtilPlugin;
export const plugin_finetune: DokaUtilPlugin;
export const plugin_resize: DokaUtilPlugin;
export const plugin_sticker: DokaUtilPlugin;
...
export const plugin_crop_defaults: CropPluginOptions;
...
/**
 * @deprecated Resize plugin doesn't have any defaults, so has been deprecated.
 */
export const plugin_resize_defaults: ResizePluginOptions;

/**
 * @deprecated Sticker plugin doesn't have any defaults, so has been deprecated.
 */
export const plugin_sticker_defaults: StickerPluginOptions;

/**
 * @deprecated use `markup_editor_defaults` instead
 */
export const plugin_annotate_defaults: AnnotatePluginOptions;

/**
 * @deprecated use `markup_editor_defaults` instead
 */
export const plugin_decorate_defaults: DecoratePluginOptions;

/**
 * @deprecated use `markup_editor_locale_en_gb` instead
 */
export const component_shape_editor_locale_en_gb: LocaleCollection;
