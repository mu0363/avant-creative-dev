...
export const ImageModal = ({ image, closeModal, getCropImage, setCompletedCrop }) => {
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto">
              ...
              <div className="flex justify-end space-x-2 border-t p-3 mt-2">
                ...
                <button className="bg-blue-400 text-white px-4 py-2 rounded-md" onClick={trimmingImage}>
                  Submit
                </button>
              </div>
            </div>
